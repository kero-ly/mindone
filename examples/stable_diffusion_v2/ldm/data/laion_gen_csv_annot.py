        ...
        for j, subfolder in enumerate(subfolders): # tar extracted
            ...
            if len(rel_img_paths) > 0:
                if one_csv_per_part:
                    ...
                    rel_img_paths = [data_dir + "/" + folder + "/" + p for p in rel_img_paths]
...
if __name__ == "__main__":
    ...
    gen_csv("/cache", one_csv_per_part=not args.save_csv_per_img_folder, folder_prefix=args.folder_prefix, start_sample_idx=args.start_sample_idx, end_sample_idx=args.end_sample_idx)